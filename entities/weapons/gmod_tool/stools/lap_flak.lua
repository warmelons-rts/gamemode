...
if (CLIENT) then
	language.Add( "Tool_lap_flak_name", "Flak Cannons" )
	language.Add( "Tool_lap_flak_desc", "Anti-air defense." )
	language.Add( "Tool_lap_flak_0", "Left-click to spawn a flak cannon. Right-click to display cost." )
	language.Add( "Undone_lap_flak", "Undone Flak Cannon" )
...
function TOOL.BuildCPanel (CPanel)
	...
	CPanel:AddControl ("Header", { Text="#Tool_lap_flak_name", Description="#Tool_lap_flak_desc" })
